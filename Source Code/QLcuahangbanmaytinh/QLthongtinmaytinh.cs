...
namespace QLcuahangbanmaytinh
{
    public partial class frmQLthongtinmaytinh : Form
    {
        ...
        {
            co.KetNoi();
            dgvmaytinh.DataSource = co.GetData("select * from ThongTinMayTinh");
            co.NgatKetNoi();
        }
        ...
        {
            string sqlthem = "insert into ThongTinMayTinh values ('" + txtmamaytinh.Text + "','" + txttenmaytinh.Text
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            string sqlsua = "update ThongTinMayTinh set MaMT='" + txtmamaytinh.Text + "',tenmt='" + txttenmaytinh.Text
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
           ...
           MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
            ...
            {
                string sqlxoa = "delete from ThongtinMayTinh where MaMT = '" + txtmamaytinh.Text + "'";
                co.ThucThi(sqlxoa);
            }
            frmQLthongtinmaytinh_Load(sender, e);
